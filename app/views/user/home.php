        ...
        <div class="box-content">
          <div class="title-index">
            ...
            <div class="btn-control">
              <div class="list-btn-control"><img src="../../../public/img/btn control/trai.png" alt=""></div>
              <div class="list-btn-control"><img src="../../../public/img/btn control/phai.png" alt=""></div>
          ...
          <div class="swiper-wrapper">
            <div class="list-food">
              <div class="food sale">
                <img src="../../../public/img/sale/1.webp" alt="">
              ...
              <div class="food sale">
                <img src="../../../public/img/sale/2.webp" alt="">
              ...
              <div class="food sale">
                <img src="../../../public/img/sale/3.webp" alt="">
              ...
              <div class="food sale">
                <img src="../../../public/img/sale/4.webp" alt="">
              ...
              <div class="food sale">
                <img src="../../../public/img/sale/5.webp" alt="">
      ...
      <div class="container_of_login_register position-relative" id="container">
        ...
        <div class="form-container sign-up-container">
          ...
          <form action="#" method="POST" id="form_register">
            ...
            <span class="span_of_login_register">or use your email for registration</span>

            <input class="input_of_login_register" id="register_username" type="text" placeholder="Username" name="username" />
            <input class="input_of_login_register" id="register_password" type="password" placeholder="Password" name="password" />
            <input class="input_of_login_register" id="register_confirm_password" type="password" placeholder="Confirm password" name="confirm_password" />

            <button id="sign_up" name="register" type="button">Sign Up</button>
          </form>
        </div>
        <div class="form-container sign-in-container">
          ...
          <form action="#" method="POST" id="form_login">
            ...
            <span class="span_of_login_register">or use your account</span>
            <input class="input_of_login_register" id="login_username" type="text" placeholder="Username" name="username" />
            <input class="input_of_login_register" id="login_password" type="password" placeholder="Password" name="password" autocomplete="false" />

            <a class="a_of_login_register" href="#">Forgot your password?</a>
            <button type="button" value="Login" id="login" name="login">Sign In</button>
          </form>
        </div>
        <div class="overlay-container">
          <div class="overlay">
            ...
            <div class="overlay-panel overlay-right">
              <h1>Hello, Friend!</h1>
              <p class="p_of_login_register">Enter your personal details and start journey with us</p>
